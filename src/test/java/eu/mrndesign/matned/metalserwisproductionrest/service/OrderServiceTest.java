...
class OrderServiceTest {
    ...
    void findByDeadlineDate() {
        ...
        assertEquals(3 , orderService.findByDeadlineDate(new Date(System.currentTimeMillis()),1,1,sortBy).size());
    }
    ...
    void findByDeadlineDateBetweenDates() {
        ...
        assertEquals(3 , orderService.findByDeadlineDateBetweenDates(new Date(System.currentTimeMillis()),new Date(System.currentTimeMillis()),1,1,sortBy).size());
    }
    ...
    void findByOrderDateBetweenDates() {
        ...
        assertEquals(3 , orderService.findByOrderDateBetweenDates(new Date(System.currentTimeMillis()),new Date(System.currentTimeMillis()),1,1,sortBy).size());
